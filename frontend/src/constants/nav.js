import { LayoutDashboard, List, Building2, Wrench, Truck, UserRound, Map as MapIcon, Calendar, ScanText } from "lucide-react";
...
export const NAV_GROUPS = [
  ...
  },
  {
    label: "Outils",
    items: [
      { key: "ocr", label: "OCR", icon: ScanText, color: "var(--status-warning)" },
    ],
  },
];
